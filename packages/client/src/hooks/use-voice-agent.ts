          ...
          new DeepgramSTT({
            ...
            options: {
              ...
              keyterms: [
                ...
                'real-time', 'streaming', 'WebSocket', 'REST API',
                // Console features
                'API key', 'API keys', 'project', 'billing', 'usage',
                'team', 'member', 'invite', 'dashboard',
                'auto-recharge', 'auto-renew', 'credits', 'balance',
                'self-hosted', 'on-premises', 'on-prem',
                // SDK & developer terms
                'SDK', 'JavaScript', 'Python', 'Go', 'Rust', '.NET',
                'Node.js', 'React', 'webhook', 'callback',
                // Audio & transcription features
                'diarization', 'punctuation', 'smart format',
                'redaction', 'PCI', 'PII', 'entity detection',
                'sentiment', 'summarization', 'topic detection',
                'keyterm', 'keyword boosting', 'utterance',
                'endpointing', 'interim results',
                // Auth & infra
                'JWT', 'Bearer token', 'API token', 'OAuth',
